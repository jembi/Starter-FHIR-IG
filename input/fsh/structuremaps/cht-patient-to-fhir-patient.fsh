...
* group.rule[=].source.context = "src"
* group.rule[=].source.element = "dateOfBirth"
...
* group.rule[=].source.context = "src"
* group.rule[=].source.element = "patientId"
...
* group.rule[=].rule.documentation = "srcBusinessID -> tgtBusinessID.system = 'http://some.identifier.namespace' \"SetBusinessIDNamespace\";"
